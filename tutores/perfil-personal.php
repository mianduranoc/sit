				...
				<div class="col-md-8">
					<!---------- Inicio Perfil Personal --------------------------------------------------------->
                 	<?php
					    ...
					    $aux = $_SESSION['usuario']['puesto_tutor'];
                                ...
                                <div class="perfil col-md-6">
                                    <div class="row info">
                                        ...
                                        <div class="col-md-7 ml-0">
                                            ...
                                            <br>
                                            <input type="text" name="correo" id="correo" class = "estatico" value =<?=$datos['correo'] ?> size="40em">
                                        </div>
                                    </div> <!----------------  Primer renglón --------------->
                                    <div class="row info">
                                        <div class="col-md-6 ml-0">
                                            ...
                                            <br>
                                            <input type="text" name = "telefono" id="telefono" class = "estatico" value=<?=$datos['telefono'] ?>>
                                        <div class="opcional">
                                            <?php if($datos['tel']=='S'): ?>
