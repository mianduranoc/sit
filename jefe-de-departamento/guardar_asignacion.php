...
elseif(isset($_POST['guardar'])) {
    ...
    $db = new ConexionBD();
    $conexion = $db->getConnection();
    $puesto = mysqli_query($conexion, "SELECT idpuesto_interno FROM puesto_interno WHERE nombre='Coordinador Departamental de Tutorias'");
    ...
    if ($datos_usuario['correo_enviado'] == 0) {
        ...
        $puesto = 'Coordinador Departamental';
