...
<head>
    ...
    ?>
	Coordinador Departamental de Tutorias</p>
            </div>
        </div> <!-- /CABECERA -->
    </header>
	</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" required name="grupo" id="grupo">
                                        <?php
                                            ...
                                            $opciones=mysqli_query($db->getConnection(),"SELECT id_grupo FROM tutor_tutorado WHERE rfc IN (SELECT rfc FROM Personal WHERE Departamento_id_depto IN (SELECT id_depto FROM Departamento WHERE nombre_depto = '$depto'))");
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sesiones=mysqli_query($conexion,"SELECT * FROM Sesion WHERE grupo IN (SELECT id_grupo FROM tutor_tutorado WHERE rfc IN (SELECT rfc FROM Personal WHERE Departamento_id_depto IN (SELECT id_depto FROM Departamento WHERE nombre_depto = '$depto'))) AND tipo = 2 AND fecha >= DATE('$hoy')");
                                ?>
                                <?php
